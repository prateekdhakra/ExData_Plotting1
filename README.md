...
A line chart of Global Active Power used.

### Plot 3

A line chart containing all three sub-metering data sets available within our data. With a well formatted legend and colorscheme for the data.

### Plot 4

A set of 4 plots that include Line charts for Global Active and Reactive Power used, Submetering data and Voltage.
